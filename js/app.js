...
window.onload = function () {
	...
	// Header
	const headerElement = document.querySelector('.bottom-header');
...
`;
	...
	<div class="item-product__content">
		<h3 class="item-product__title title">${productTitle}</h3>
	</div>
`;

			let productTemplatePrices = '';
			let productTemplatePricesStart = `<div class="item-product__prices">`;
			let productTemplatePricesCurrent = `<div class="item-product__price rub price">${productPrice}</div>`;
			let productTemplatePricesOld = `<div class="item-product__price item-product__price_old rub">${productOldPrice}</div>`;
	...
	<div class="item-product__actions actions-product">
		<div class="actions-product__body">
			<a href="" class="actions-product__button btn btn_white">ДОБАВИТЬ</a>
			<a href="${productLikeUrl}" class="actions-product__link actions-product__link_favorite">Нравится</a>
			<a href="${productShareUrl}" class="actions-product__link actions-product__link_share">Поделиться</a>
		</div>
	</div>
`;
		...
		if (productAdd) {
			...
			if (!cartProduct) {
				...
				<div class="cart-list__body">
					...
					<div class="cart-list__quantity">Товаров: <span>1</span></div>
...
if (document.querySelector('.slider-blog__body')) {
	new Swiper('.slider-blog__body', {
		...
		// Arrows
		navigation: {
			nextEl: '.slider-blog .slider-arrow_next',
			prevEl: '.slider-blog .slider-arrow_prev',
		},
		breakpoints: {
...
if (document.querySelector('.main-slider__latest')) {
	let productsSlider = new Swiper('.main-slider__latest', {
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		spaceBetween: 0,
		...
		// Arrows
		navigation: {
			nextEl: '.main-slider__arrows-latest .slider-arrow_next',
			prevEl: '.main-slider__arrows-latest .slider-arrow_prev',
		},
		on: {
...
if (document.querySelector('.main-slider__top')) {
	let productsSlider = new Swiper('.main-slider__top', {
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		spaceBetween: 0,
		...
		// Arrows
		navigation: {
			nextEl: '.main-slider__arrows-top .slider-arrow_next',
			prevEl: '.main-slider__arrows-top .slider-arrow_prev',
		},
		on: {
			lazyImageReady: function () {
				ibg();
...
if (document.querySelector('.main-slider__reviews')) {
	let productsSlider = new Swiper('.main-slider__reviews', {
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		spaceBetween: 0,
		...
		// Arrows
		navigation: {
			nextEl: '.main-slider__arrows-reviews .slider-arrow_next',
			prevEl: '.main-slider__arrows-reviews .slider-arrow_prev',
		},
		on: {
			lazyImageReady: function () {
				ibg();
